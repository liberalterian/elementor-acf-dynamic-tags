...
/**
 * Elementor Dynamic Tag - ACF Email Tag
 *
 ...
 */
 ...
 class ACF_Dynamic_Email_Tag extends \Elementor\Core\DynamicTags\Tag {

	/**
	 * Get dynamic tag name.
	 *
	 * Retrieve the name of the ACF email tag.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Returns the title of the ACF email tag.
	 *
	 * @since 1.0.0
	 * @access public
	...
	public function get_title() {
		return esc_html__( 'ACF Email', 'elementor-acf-dynamic-tags' );
	}

	/**
	 * Get dynamic tag groups.
	 *
	 * Retrieve the list of groups the ACF email tag belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Retrieve the list of categories the ACF email tag belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Add input fields to allow the user to customize the ACF email tag settings.
	 *
	 * @since 1.0.0
	 * @access protected
	 * @return void
